...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--sample-interval", type=float, default=0.2) # Time interval between sensor readings in seconds (default: 0.1s)
    ...
    parser.add_argument("--min-high", type=float, default=0.5) # Minimum duration in seconds that the sensor signal must be high to consider it a valid motion event (default: 0s, i.e. any high signal is valid)
